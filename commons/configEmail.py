...
class Email:
    ...
    def config_content(self,datas):
        ...
        # content = f.read()
        # f.close()
        testhj=localReadConfig.get_http("baseurl")
        content = email_data % (testhj, datas[0][1], datas[1][1], datas[2][1])
        # print(content)
